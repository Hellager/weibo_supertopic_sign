...
1. 本地使用 <br>
    ...
    ```
2. 腾讯云函数运行 <br>
    * 登录 **腾讯云**， 打开右上角 **控制台**， 找到 **我的资源** -> **云函数**，点击打开, 找到 **函数服务** -> **新建**， 选择 **自定义创建**， 设置 **函数名称**， 选择 **本地上传ZIP包**， 上传 [supertopic_sign_V1.0.2](https://pan.baidu.com/s/1PY8odOpWVeRBXvGg91RqJQ) 提取码 kd1q，点击完成，完成新建云函数 <br>
